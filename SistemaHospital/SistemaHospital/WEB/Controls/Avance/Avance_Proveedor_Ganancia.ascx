<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Avance_Proveedor_Ganancia.ascx.cs" Inherits="SistemaHospital.WEB.Controls.Avance.Avance_Proveedor_Ganancia" %>
