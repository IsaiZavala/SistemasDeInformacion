<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Avance_Medico.ascx.cs" Inherits="SistemaHospital.WEB.Controls.Avance.Avance_Medico" %>

<div class="row">
    <div class="col-md-4">
        <div class="input-group">
            <span class="input-group-addon">IdMedico</span>&nbsp;&nbsp;
