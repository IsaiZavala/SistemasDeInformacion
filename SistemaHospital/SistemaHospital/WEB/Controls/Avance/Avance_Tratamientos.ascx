<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Avance_Tratamientos.ascx.cs" Inherits="SistemaHospital.WEB.Controls.Avance.Avance_Tratamientos" %>

<div class="row">
    <div class="col-md-4">
        <div class="input-group">
            <span class="input-group-addon">IdTratamiento</span>&nbsp;&nbsp;
