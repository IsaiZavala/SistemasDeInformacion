<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MinMax_Medicos.ascx.cs" Inherits="SistemaHospital.WEB.Controls.MinMax.MinMax_Medicos" %>


<div class="row">
    <div class="col-md-4">
        <div class="input-group">
            <span class="input-group-addon">Cantidad de registros&nbsp;&nbsp;&nbsp; </span>&nbsp;<asp:TextBox ID="txtcant_Registros" CssClass="form-control" runat="server"></asp:TextBox>
        </div>
    </div>
    <div class="col-md-4">
        <div class="input-group">
